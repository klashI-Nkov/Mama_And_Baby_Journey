...
public class Workplace_Data_Activity extends AppCompatActivity implements AdapterView . OnItemSelectedListener
{
    ...
    */
    ...
    /*
       هاد الفنكشن مستعمله عشان اعرض مسجل معين و مستعمله في فنكشن ال Save_Workplace_Data_BTN

       داخل ال else وهو نفس الفنكشن الي في كلاس ال Map و في كلاس ال Days_And_Working_Hours_Activity وفي كلاسات ثانيه

       لكن هاد الفنكشن الي في هاي الكلاس و في كلاس ال Days_And_Working_Hours_Activity وفي الكلاسات الثاني فيهم فرق بسيط عن الي

       موجود في كلاس ال Map لحتى تعرفي شو الفرق ادخلي جواته رح تلاقي في كومنت مكتوب قبله

       بس مش هسه تخشي تشوفي الفرق بس يجيه دوره لحتى تقري شو المكتوب جواته
    */
